...
<div class="main-box">
	...
	<div class="main-box-body clearfix">
		<form class="form-horizontal" role="form" id="form_product">
			<div class="form-group">
				<label for="code" class="col-lg-2 control-label">产品代码<font color="red">*</font>:</label>
				<div class="col-lg-5">
			...
			<div class="form-group">
				<label for="name" class="col-lg-2 control-label">产品名称<font color="red">*</font>:</label>
				<div class="col-lg-5">
			...
			<div class="form-group">
				<label for="mgrIds" class="col-lg-2 control-label">产品管理员<font color="red">*</font>:</label>
				<div class="col-lg-5">
