		...
		<div class="main-box clearfix">
			<div class="filter-block pull-left">
				<div class="form-group pull-left">
					<div class="form-group pull-left">&nbsp;镜像名:</div>
					<div class="form-group pull-left">
						<input type="text" name="imageFullName" id="imageFullName"
					...
					<div class="form-group pull-left">是否外部镜像:</div>
					<div class="form-group pull-left">
						<select id="sel_isExternal" class="form-control"
							style="width: 120px;">
						</select>
					</div>
				</div>
